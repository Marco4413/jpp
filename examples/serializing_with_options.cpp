...
int main(int argc, const char **argv)
{
    ...
    const std::filesystem::path file_path = shift_args(argc, argv, "examples/serializing_with_options.json");
    ...
    jpp::serializer::options options;
    options.indent_size = 0;

    std::cout << jpp::serialize(value, options) << std::endl;
